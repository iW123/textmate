...
- (instancetype)initWithFrame:(NSRect)frameRect tabItem:(OakTabItem*)tabItem parent:(OakTabBarView*)tabBarView
{
	if(self = [super initWithFrame:frameRect])
	{
		...
		[self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(8@53)-[close]-(>=3@53)-[title]-(>=6@53)-|" options:0 metrics:nil views:views]];
...
- (void)setCurrentLayout:(NSArray<OakTabFrame*>*)newLayout
{
    ...
    CGFloat x = -1, y = NSMinY(self.bounds)+1, height = 32;  // NSHeight(self.bounds)-1;
